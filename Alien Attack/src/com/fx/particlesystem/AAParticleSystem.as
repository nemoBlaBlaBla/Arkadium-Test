package com.fx.particlesystem
{
	 ...
	 * @author Eugene
	 */
	public class AAParticleSystem extends Sprite
	{		
		...
		public function AAParticleSystem(emissionDelayInMS:int = 1000, particleVelocity:int = 0, xRange:uint = 0, yRange:uint = 0)
		{
		...
		public function EmitParticles():void
		{
			...
			{
				var p:AAParticle = new AAParticle();
